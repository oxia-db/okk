...
import (
	...
	"github.com/oxia-io/okk/internal/controller"
...
func init() {
	...
	flags := Cmd.Flags()
	flags.StringVar(&metricsAddr, "metrics-bind-address", "localhost:8080", "The address the metrics endpoint binds to. "+
...
func exec(cmd *cobra.Command, args []string) {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "815dfe12.oxia.io",
...
// nolint:gocyclo
func main() {
	pprof.Do(context.Background(), pprof.Labels("component", "main"),
		func(ctx context.Context) {
			if err := automaxprocs.Set(); err != nil {
